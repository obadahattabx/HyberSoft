    ...
    <div className="row">
      <div className="col-lg-12">
        <nav className="navbar navbar-expand-lg">
          ...
          <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarThree" aria-controls="navbarThree" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <div className="collapse navbar-collapse sub-menu-bar" id="navbarThree">
            <ul className="navbar-nav ms-auto">
              <li className="nav-item">
                <a className="page-scroll active" data-bs-toggle="collapse" data-bs-target="#sub-nav5" aria-controls="sub-nav5" aria-expanded="false" aria-label="Toggle navigation" href="javascript:void(0)">About
                  <div className="sub-nav-toggler">
                    <span><i className="lni lni-chevron-down" /></span>
                  </div>
                </a>
                <ul className="sub-menu collapse" id="sub-nav5">
                  <li><a href="javascript:void(0)">Dropdown Menu 1</a></li>
                  <li>
                    <a className="page-scroll active" data-bs-toggle="collapse" data-bs-target="#sub-nav6" aria-controls="sub-nav6" aria-expanded="false" aria-label="Toggle navigation" href="javascript:void(0)">Dropdown Menu 2
                      <div className="sub-nav-toggler">
                        <span><i className="lni lni-chevron-down" /></span>
                      </div>
                    </a>
          ...
          <div className="navbar-social d-none d-sm-inline-block">
            <ul>
              ...
              <li>
                <a href="javascript:void(0)"><i className="lni lni-instagram-original" /></a>
              </li>
            </ul>
          </div>
        </nav>
