  ...
  <div className="bd-example">
    <div id="carouselOne" className="carousel slide" data-bs-ride="carousel">
      ...
      <div className="carousel-inner">
        <div className="carousel-item bg_cover active" style={{backgroundImage: `url(${img})`}}>
        ...
        {/* carousel-item */}
        <div className="carousel-item bg_cover" style={{backgroundImage: `url(${img2})`}} >
          <div className="carousel-caption">
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-xl-6 col-lg-7 col-sm-10">
        ...
        {/* carousel-item */}
        <div className="carousel-item bg_cover" style={{backgroundImage: `url(${img3})`}}>
          <div className="carousel-caption">
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-xl-6 col-lg-7 col-sm-10">
